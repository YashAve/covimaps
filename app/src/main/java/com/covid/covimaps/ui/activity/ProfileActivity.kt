...
private lateinit var agreeToDisclaimer: () -> Unit
...
fun Profile(modifier: Modifier = Modifier) {
    ...
    var disclaimer by rememberSaveable { mutableStateOf(true) }
...
/*dataStoreManager?.isAgreedToDisclaimer()*//*
            ...
            */
/*disclaimer = dataStoreManager?.isAgree!!*//*
    ...
    Surface(color = MaterialTheme.colorScheme.surfaceVariant) {
        Scaffold(topBar = {
            ...
            Box(modifier = Modifier.padding(scaffold)) {
                if (disclaimer) DisclaimerDialog(readOutLoud = readOutLoud, onAgree = {
                    */
/*agreeToDisclaimer()*//*
